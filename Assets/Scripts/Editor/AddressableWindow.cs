...
/*            Generator.ClearAll();
    ...
    [BoxGroup("一键依赖ab包到StreamingAssets目录", true, true), ButtonGroup("一键依赖ab包到StreamingAssets目录/Button"), Button("依赖", ButtonSizes.Large), GUIColor(0, 1, 0)]
    private void SetStreamingAssets()
    {
